        ...
        <Flex justify="space-between">
          ...
          <Group gap="md">
            <Group visibleFrom="md" gap="lg">
              ...
              <Anchor mt={3} c="white" fw="bold" underline="never" component={Link} href={Routes.USERS} children="ユーザー情報" />
            </Group>
            ...
            <Drawer position="right" opened={showMenu} onClose={toggleMenu}>
              <Stack gap="lg">
                ...
                <Anchor underline="never" href={Routes.USERS} fw="bold" children="ユーザー一覧" />
              </Stack>
            </Drawer>
          </Group>
        </Flex>
